...
const isEmpty = computed(() => props.customers.data.length === 0);
</script>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6">
            <div class="mx-auto max-w-7xl space-y-4 sm:px-6 lg:px-8">
                <div class="rounded-xl border border-teal-100 bg-white/90 shadow-sm shadow-teal-100/50">
                    ...
                    <div v-else>
                        ...
                        <div class="space-y-3 p-4 lg:hidden">
                            <article v-for="customer in customers.data" :key="customer.id" class="rounded-lg border border-slate-200 p-4">
                ...
                <div v-if="customers.links && !isEmpty" class="flex justify-center">
                    <div class="flex flex-wrap items-center justify-center gap-2">
                        <template v-for="(link, index) in customers.links" :key="`${index}-${link.label}-${link.url}`">
                            <Link
                                v-if="link.url"
                                :href="link.url"
                                :class="link.active
