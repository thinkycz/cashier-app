    ...
    <div class="text-[11px] leading-tight text-slate-800">
        <table class="w-full">
            ...
            <tr class="border-y-2 border-teal-700 bg-teal-50/70">
                <td class="py-1.5 text-center font-semibold text-teal-900" colspan="100%">Objednávka</td>
            </tr>
            <tr class="bg-slate-50">
                <td class="px-1 py-1.5 font-semibold uppercase tracking-wide text-slate-700">Položka</td>
