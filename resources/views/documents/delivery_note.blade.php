...
<div class="flex min-h-[295mm] flex-col px-[18mm] pb-[14mm] pt-[12mm] text-[11px] leading-snug text-slate-900">
    <div class="pt-6">
        ...
        <div class="mt-3 flex items-baseline justify-between gap-6">
            <p class="text-2xl font-semibold tracking-tight">{{ __('Delivery Note') }}</p>
        ...
        <table class="w-full border-collapse">
            <thead>
                <tr class="border-b border-slate-300">
                    ...
                    <th class="py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-slate-500">{{ __('Name') }}</th>
